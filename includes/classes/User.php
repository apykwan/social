...
class User {
    ...
    public function removeFriend($user_to_remove) {
        ...
        // remove user from your friend_array
        $new_friend_array = str_replace($user_to_remove . ",", "", $this->user['friend_array']);    //Remove friend's name from friend_array string
		$remove_friend = mysqli_query($this->con, "UPDATE users SET friend_array='$new_friend_array' WHERE username='$logged_in_user'");
        // remove you from user's friend_array
